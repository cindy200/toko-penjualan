...
<?php if (empty($barang)):?>
  <dif class="alert alert-danger" role="alert">
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      >Detail</a> 
      <a href="<?= base_url(); ?>barang/ubah/<?= $brg['id_barang']; ?>" class="btn btn-success"> 
      >Ubah</a> 
      <a href="<?= base_url(); ?>barang/hapus/<?= $brg['id_barang']; ?>" class="btn btn-danger"> 
